...
\begin{tikzpicture}[node distance = 2cm, auto]
    % Place nodes
    \node [block] (OCP) {Optimal Control Problem};
    
    \node [block, below of=OCP, distance=2cm] (QP) {Quadratic Programming};
    
    \node [block, below of=QP, node distance=2cm] (Directional_Derivative) {Directional Derivative \ref{label_directional_derivative}  };
